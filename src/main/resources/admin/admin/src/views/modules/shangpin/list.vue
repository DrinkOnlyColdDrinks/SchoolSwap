        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '闲置物品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="闲置物品名称" clearable></el-input>
                     </el-form-item>

                     <el-form-item :label="contents.inputTitle == 1 ? '闲置物品类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择闲置物品类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanxianzhiwupinjiaoyi/upload/shangpinMuBan.xls"
                        >批量导入闲置物品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">增加闲置物品库存</el-button>-->
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">减少闲置物品库存</el-button>-->
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '闲置物品名称': "shangpinName",
                     '闲置物品照片': "shangpinPhoto",
                     '闲置物品类型': "shangpinTypes",
                     '闲置物品库存': "shangpinKucunNumber",
                     '原价': "shangpinOldMoney",
                     '现价': "shangpinNewMoney",
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shangpinKucunNumberTitle = '增加闲置物品库存'
			},
			//减少闲置物品库存
			...
			//数据不为空放值
				...
				this.shangpinKucunNumberVisible = true;
				//标题
				this.shangpinKucunNumberTitle = '减少闲置物品库存'
			},
			//提交用户操作闲置物品库存数量
			addShangpinKucunNumber(){
				...
				if(this.kucunNumberTypes == "+"){
					...
					if(this.shangpinKucunNumber < this.kucunNumber || this.kucunNumber <= 0){
						this.$message.error('闲置物品库存不足不能减少');
						return false;
					}else{
						maxNumber = this.shangpinKucunNumber - this.kucunNumber
					}
